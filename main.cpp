...
int sc_main(int argc, char *argv[])
{
  ...
  sc_signal<sc_uint<WIDTH>> s_i_c_msg;
  sc_signal<bool> s_i_c_rdy;
  sc_signal<bool> s_i_c_vld;
  ...
  testbench.o_c.msg(s_i_c_msg);
  testbench.o_c.vld(s_i_c_vld);
  testbench.o_c.rdy(s_i_c_rdy);
  ...
  dut.i_b_port.msg(s_i_c_msg);
  dut.i_b_port.vld(s_i_c_vld);
  dut.i_b_port.rdy(s_i_c_rdy);
