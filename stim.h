...
SC_MODULE(stim)
{
  ...
  // o_c output ports: message, ready, valid signals
  rdyvld_port_out<sc_uint<WIDTH>> o_c;
  ...
  void monitor()
  {
    cout << setw(8) << "time" << setw(8) << "a" << setw(8) << "a rdy" << setw(8) << "a vld" << setw(8) << "b"
         << setw(8) << "b rdy" << setw(8) << "b vld" << setw(8) << "c" << setw(8) << "c rdy" << setw(8) << "c vld"
    ...
    while (true)
    {
      ...
      t_c = o_c.msg.read();
      t_c_rdy = o_c.rdy.read();
      t_c_vld = o_c.vld.read();
      ...
      cout << setw(8) << t_c.to_string(SC_BIN);
      cout << setw(8) << t_c_rdy.to_string(SC_BIN);
      cout << setw(8) << t_c_vld.to_string(SC_BIN);
